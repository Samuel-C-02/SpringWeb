...
public class JWTService {
    ...
    public <T> T getClaim(String token, Function<Claims, T> extractClaim) {
    ...
    public String generateToken(Map<String, Object> extraClaim, UserDTO userDetails) {
        return buildToken(extraClaim, userDetails, jwtExpiration);
    }

    public String buildToken(Map<String, Object> extraClaim, UserDTO userDetails, long jwtExpiration) {
        return Jwts
                .builder()
    ...
    public boolean isTokenValid(String token, UserDetails userDetails) {
        return getJwtUsername(token).equals(userDetails.getUsername()) && !isTokenExpired(token);
    }
